...
export const ui = {
  en: {
    ...
    guide: {
      ...
      esimWhenUseful: 'When an eSIM may be useful',
      esimConnectionOptions: 'eSIM and backup connection options',
      esimPurchaseChecks: 'What to check before buying',
      esimActivationCompatibility: 'Activation and device compatibility',
      esimFirstWeekTips: 'First-week internet tips',
      esimWhatYouNeed: 'What you may need',
      esimCoveragePackage: 'Coverage and data-package reminders',
  ...
  tr: {
    ...
    guide: {
      ...
      whatIsEsim: 'eSIM nedir?',
      esimWhenUseful: 'eSIM ne zaman faydalı olabilir?',
      esimConnectionOptions: 'eSIM ve yedek bağlantı seçenekleri',
      esimPurchaseChecks: 'Satın almadan önce kontrol edilecekler',
      esimActivationCompatibility: 'Aktivasyon ve cihaz uyumluluğu',
      esimFirstWeekTips: 'İlk hafta internet ipuçları',
      esimWhatYouNeed: 'Gerekebilecekler',
      esimCoveragePackage: 'Kapsama ve internet paketi hatırlatmaları',
  ...
  ru: {
    ...
    guide: {
      ...
      esimWhenUseful: 'Когда eSIM может быть полезна',
      esimConnectionOptions: 'eSIM и запасные варианты подключения',
      esimPurchaseChecks: 'Что проверить до покупки',
      esimActivationCompatibility: 'Активация и совместимость устройства',
      esimFirstWeekTips: 'Советы по интернету на первую неделю',
      esimWhatYouNeed: 'Что может понадобиться',
      esimCoveragePackage: 'Покрытие и параметры пакета данных',
