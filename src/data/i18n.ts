...
export const ui = {
  en: {
    ...
    guide: {
      ...
      transportApps: 'Taxi and ride-hailing apps',
      publicTransportBasics: 'Public transport basics',
      airportToCity: 'Airport-to-city basics',
      mapsNavigation: 'Maps and navigation',
      transportFirstWeekTips: 'First-week transport tips',
      prepareBeforeArrival: 'What to prepare before arrival',
      transportChecks: 'Details to check before travelling',
      transportAppsSection: 'Transport and taxi apps',
      housingWhereToSearch: 'Where to search for housing',
      shortVsLongHousing: 'Short-term stay or longer rental?',
      housingFirstWeekTips: 'First-week housing tips',
      housingChecks: 'What to check before agreeing',
      housingLocationTransport: 'Location and transport access',
      housingPrepare: 'Details to prepare',
      housingContractBasics: 'Deposit, contract and communication basics',
      bankingBasics: 'Banking basics for newcomers',
      bankingDocuments: 'Documents that may be requested',
      bankingQuestions: 'Questions to ask before opening an account',
      paymentBasics: 'Cash, card and mobile payment basics',
      currencyTransfer: 'Currency and international transfer reminders',
      bankingFirstWeekTips: 'First-week banking and money tips',
      bankingFeesDetails: 'Fees and account details to compare',
  ...
  tr: {
    ...
    guide: {
      ...
      transportApps: 'Taksi ve araç çağırma uygulamaları',
      publicTransportBasics: 'Toplu taşıma temelleri',
      airportToCity: 'Havalimanından şehre ulaşım',
      mapsNavigation: 'Harita ve navigasyon',
      transportFirstWeekTips: 'İlk hafta ulaşım ipuçları',
      prepareBeforeArrival: 'Gelmeden önce hazırlanacaklar',
      transportChecks: 'Yola çıkmadan kontrol edilecekler',
      transportAppsSection: 'Ulaşım ve taksi uygulamaları',
      housingWhereToSearch: 'Ev aramaya nereden başlanır?',
      shortVsLongHousing: 'Kısa süreli konaklama mı, uzun dönem kiralama mı?',
      housingFirstWeekTips: 'İlk hafta ev arama ipuçları',
      housingChecks: 'Anlaşmadan önce kontrol edilecekler',
      housingLocationTransport: 'Konum ve ulaşım erişimi',
      housingPrepare: 'Hazırlanacak bilgiler',
      housingContractBasics: 'Depozito, sözleşme ve iletişim temelleri',
      bankingBasics: 'Yeni gelenler için bankacılık temelleri',
      bankingDocuments: 'İstenebilecek belgeler',
      bankingQuestions: 'Hesap açmadan önce sorulacak sorular',
      paymentBasics: 'Nakit, kart ve mobil ödeme temelleri',
      currencyTransfer: 'Döviz ve uluslararası transfer hatırlatmaları',
      bankingFirstWeekTips: 'İlk hafta bankacılık ve para ipuçları',
      bankingFeesDetails: 'Karşılaştırılacak ücretler ve hesap detayları',
  ...
  ru: {
    ...
    guide: {
      ...
      transportApps: 'Такси и приложения для поездок',
      publicTransportBasics: 'Основы общественного транспорта',
      airportToCity: 'Как добраться из аэропорта в город',
      mapsNavigation: 'Карты и навигация',
      transportFirstWeekTips: 'Советы по транспорту на первую неделю',
      prepareBeforeArrival: 'Что подготовить до приезда',
      transportChecks: 'Что проверить перед поездкой',
      transportAppsSection: 'Транспортные приложения и такси',
      housingWhereToSearch: 'Где искать жильё',
      shortVsLongHousing: 'Краткосрочное жильё или долгосрочная аренда?',
      housingFirstWeekTips: 'Советы по жилью на первую неделю',
      housingChecks: 'Что проверить до согласия',
      housingLocationTransport: 'Расположение и транспорт',
      housingPrepare: 'Что подготовить',
      housingContractBasics: 'Депозит, договор и общение',
      bankingBasics: 'Основы банковских услуг для новых приезжих',
      bankingDocuments: 'Какие документы могут запросить',
      bankingQuestions: 'Что спросить до открытия счёта',
      paymentBasics: 'Наличные, карты и мобильные платежи',
      currencyTransfer: 'Валюта и международные переводы',
      bankingFirstWeekTips: 'Банковские и денежные советы на первую неделю',
      bankingFeesDetails: 'Комиссии и условия счёта для сравнения',
