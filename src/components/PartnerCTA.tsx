...
export default function PartnerCTA({ language }: PartnerCTAProps) {
  ...
  return (
    <section className="flex h-full flex-col rounded-[1.25rem] border border-sky-200/15 bg-[linear-gradient(135deg,#101c2c_0%,#15334a_100%)] p-5 text-white shadow-[0_18px_50px_rgba(0,0,0,0.26)]">
      <div className="flex h-full flex-col">
        ...
        <div className="mt-auto pt-4">
          <a
            ...
            className="focus-ring inline-flex shrink-0 items-center justify-center gap-2 rounded-full bg-white px-4 py-2.5 text-sm font-bold text-ink shadow-sm transition hover:bg-blue-50"
          >
